...
class LockPatternView : View {
    ...
    lateinit  var  finishUpListener : FinishUpListener;
    ...
    override fun onTouchEvent(event: MotionEvent): Boolean {
        ...
        when (event.action) {
            ...
            MotionEvent.ACTION_UP -> {
                ...
                finishUpListener.onFinishUp(mSelectPoints)
    ...
    fun onSucess () {
        for (mSelectPoint in mSelectPoints) {
    ...
    interface FinishUpListener {
        public fun onFinishUp(list :ArrayList<Point>);
    }
